...
class Routes(
  ...
  // @LINE:75
  private[this] lazy val controllers_UserController_gUser43_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("user/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_UserController_gUser43_invoker = createInvoker(
    UserController_18.gUser(fakeValue[Long]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.UserController",
      "gUser",
  ...
  // @LINE:77
  private[this] lazy val controllers_UserController_deleteUser44_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("deleteuser/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_UserController_deleteUser44_invoker = createInvoker(
  ...
  private[this] lazy val controllers_OrderController_addOrder45_invoker = createInvoker(
  ...
  private[this] lazy val controllers_OrderController_updateOrder47_invoker = createInvoker(
  ...
  private[this] lazy val controllers_OrderController_updateOrderHandle48_invoker = createInvoker(
  ...
  private[this] lazy val controllers_OrderController_getOrder50_invoker = createInvoker(
  ...
  private[this] lazy val controllers_OrderController_deleteOrder52_invoker = createInvoker(
  ...
  private[this] lazy val controllers_BasketController_addToBasket53_invoker = createInvoker(
  ...
  private[this] lazy val controllers_ApplicationController_addToBasketHandle54_invoker = createInvoker(
  ...
  private[this] lazy val controllers_BasketController_updateBasket55_invoker = createInvoker(
  ...
  private[this] lazy val controllers_BasketController_updateBasketHandle56_invoker = createInvoker(
  ...
  private[this] lazy val controllers_ApplicationController_basketContent57_invoker = createInvoker(
  ...
  private[this] lazy val controllers_BasketController_deleteFromBasket58_invoker = createInvoker(
  ...
  private[this] lazy val controllers_PaymentController_addPayment59_invoker = createInvoker(
  ...
  private[this] lazy val controllers_PaymentController_addPaymentHandle60_invoker = createInvoker(
  ...
  private[this] lazy val controllers_PaymentController_updatePayment61_invoker = createInvoker(
  ...
  private[this] lazy val controllers_PaymentController_updatePaymentHandle62_invoker = createInvoker(
  ...
  private[this] lazy val controllers_PaymentController_getPayment63_invoker = createInvoker(
  ...
  private[this] lazy val controllers_PaymentController_getPayments64_invoker = createInvoker(
  ...
  private[this] lazy val controllers_PaymentController_getPaymentOrd65_invoker = createInvoker(
  ...
  private[this] lazy val controllers_PaymentController_deletePayment66_invoker = createInvoker(
  ...
  private[this] lazy val controllers_FavoritesController_addFavorites67_invoker = createInvoker(
  ...
  private[this] lazy val controllers_ApplicationController_addFavoritesHandle68_invoker = createInvoker(
  ...
  // @LINE:122
  private[this] lazy val controllers_FavoritesController_updateFavoritesHandle69_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("updatefavoriteshandle")))
  )
  private[this] lazy val controllers_FavoritesController_updateFavoritesHandle69_invoker = createInvoker(
  ...
  // @LINE:124
  private[this] lazy val controllers_ApplicationController_favoritesContent70_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("favorites")))
  )
  private[this] lazy val controllers_ApplicationController_favoritesContent70_invoker = createInvoker(
  ...
  // @LINE:125
  private[this] lazy val controllers_FavoritesController_getFavorit71_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("favorit/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_FavoritesController_getFavorit71_invoker = createInvoker(
  ...
  // @LINE:126
  private[this] lazy val controllers_FavoritesController_getFavoritesUsr72_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("favoritesusr/"), DynamicPart("userid", """[^/]+""",true)))
  )
  private[this] lazy val controllers_FavoritesController_getFavoritesUsr72_invoker = createInvoker(
  ...
  // @LINE:127
  private[this] lazy val controllers_FavoritesController_deleteFavorites73_route = Route("GET",
  ...
  private[this] lazy val controllers_FavoritesController_deleteFavorites73_invoker = createInvoker(
  ...
  // @LINE:130
  private[this] lazy val controllers_DiscountController_addDiscount74_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("adddiscount/"), DynamicPart("product_id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_DiscountController_addDiscount74_invoker = createInvoker(
  ...
  // @LINE:132
  private[this] lazy val controllers_DiscountController_addDiscountHandle75_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("adddiscounthandle")))
  )
  private[this] lazy val controllers_DiscountController_addDiscountHandle75_invoker = createInvoker(
  ...
  // @LINE:133
  private[this] lazy val controllers_DiscountController_updateDiscount76_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("updatediscount/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_DiscountController_updateDiscount76_invoker = createInvoker(
  ...
  // @LINE:135
  private[this] lazy val controllers_DiscountController_updateDiscountHandle77_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("updatediscounthandle")))
  )
  private[this] lazy val controllers_DiscountController_updateDiscountHandle77_invoker = createInvoker(
  ...
  // @LINE:137
  private[this] lazy val controllers_DiscountController_getDiscounts78_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("discounts")))
  )
  private[this] lazy val controllers_DiscountController_getDiscounts78_invoker = createInvoker(
  ...
  // @LINE:138
  private[this] lazy val controllers_DiscountController_getDiscountpr79_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("discountpr/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_DiscountController_getDiscountpr79_invoker = createInvoker(
  ...
  // @LINE:139
  private[this] lazy val controllers_DiscountController_getDiscount80_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("discount/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_DiscountController_getDiscount80_invoker = createInvoker(
  ...
  // @LINE:140
  private[this] lazy val controllers_DiscountController_deleteDiscount81_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("deletediscount/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_DiscountController_deleteDiscount81_invoker = createInvoker(
  ...
  // @LINE:143
  private[this] lazy val controllers_DeliveryController_addDelivery82_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("adddelivery")))
  )
  private[this] lazy val controllers_DeliveryController_addDelivery82_invoker = createInvoker(
  ...
  // @LINE:145
  private[this] lazy val controllers_DeliveryController_addDeliveryHandle83_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("adddeliveryhandle")))
  )
  private[this] lazy val controllers_DeliveryController_addDeliveryHandle83_invoker = createInvoker(
  ...
  // @LINE:146
  private[this] lazy val controllers_DeliveryController_updateDelivery84_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("updatedelivery/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_DeliveryController_updateDelivery84_invoker = createInvoker(
  ...
  // @LINE:148
  private[this] lazy val controllers_DeliveryController_updateDeliveryHandle85_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("updatedeliveryhandle")))
  )
  private[this] lazy val controllers_DeliveryController_updateDeliveryHandle85_invoker = createInvoker(
  ...
  // @LINE:150
  private[this] lazy val controllers_DeliveryController_getDeliverys86_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("deliverys")))
  )
  private[this] lazy val controllers_DeliveryController_getDeliverys86_invoker = createInvoker(
  ...
  // @LINE:151
  private[this] lazy val controllers_DeliveryController_getDelivery87_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("delivery/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_DeliveryController_getDelivery87_invoker = createInvoker(
  ...
  // @LINE:152
  private[this] lazy val controllers_DeliveryController_getDeliveryOrd88_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("deliveryord/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_DeliveryController_getDeliveryOrd88_invoker = createInvoker(
  ...
  // @LINE:153
  private[this] lazy val controllers_DeliveryController_deleteDelivery89_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("deletedelivery/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_DeliveryController_deleteDelivery89_invoker = createInvoker(
  ...
  // @LINE:156
  private[this] lazy val controllers_ReviewController_addReview90_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("addreview")))
  )
  private[this] lazy val controllers_ReviewController_addReview90_invoker = createInvoker(
  ...
  // @LINE:158
  private[this] lazy val controllers_ApplicationController_addReviewHandle91_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("addreviewhandle")))
  )
  private[this] lazy val controllers_ApplicationController_addReviewHandle91_invoker = createInvoker(
  ...
  // @LINE:159
  private[this] lazy val controllers_ReviewController_updateReview92_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("updatereview/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_ReviewController_updateReview92_invoker = createInvoker(
  ...
  // @LINE:161
  private[this] lazy val controllers_ReviewController_updateReviewHandle93_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("updatereviewhandle")))
  )
  private[this] lazy val controllers_ReviewController_updateReviewHandle93_invoker = createInvoker(
  ...
  // @LINE:164
  private[this] lazy val controllers_ReviewController_review94_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("review/"), DynamicPart("productid", """[^/]+""",true)))
  )
  private[this] lazy val controllers_ReviewController_review94_invoker = createInvoker(
  ...
  // @LINE:165
  private[this] lazy val controllers_ReviewController_deleteReview95_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("deletereview/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_ReviewController_deleteReview95_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:75
    case controllers_UserController_gUser43_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_UserController_gUser43_invoker.call(UserController_18.gUser(id))
      }
  
    // @LINE:77
    case controllers_UserController_deleteUser44_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
    ...
    // @LINE:122
    case controllers_FavoritesController_updateFavoritesHandle69_route(params@_) =>
      call { 
        controllers_FavoritesController_updateFavoritesHandle69_invoker.call(FavoritesController_11.updateFavoritesHandle)
      }
  
    // @LINE:124
    case controllers_ApplicationController_favoritesContent70_route(params@_) =>
      call { 
        controllers_ApplicationController_favoritesContent70_invoker.call(ApplicationController_12.favoritesContent)
      }
  
    // @LINE:125
    case controllers_FavoritesController_getFavorit71_route(params@_) =>
      call(params.fromPath[Int]("id", None)) { (id) =>
        controllers_FavoritesController_getFavorit71_invoker.call(FavoritesController_11.getFavorit(id))
      }
  
    // @LINE:126
    case controllers_FavoritesController_getFavoritesUsr72_route(params@_) =>
      call(params.fromPath[Long]("userid", None)) { (userid) =>
        controllers_FavoritesController_getFavoritesUsr72_invoker.call(FavoritesController_11.getFavoritesUsr(userid))
      }
  
    // @LINE:127
    case controllers_FavoritesController_deleteFavorites73_route(params@_) =>
      call(params.fromPath[Long]("productid", None)) { (productid) =>
        controllers_FavoritesController_deleteFavorites73_invoker.call(FavoritesController_11.deleteFavorites(productid))
      }
  
    // @LINE:130
    case controllers_DiscountController_addDiscount74_route(params@_) =>
      call(params.fromPath[Long]("product_id", None)) { (product_id) =>
        controllers_DiscountController_addDiscount74_invoker.call(DiscountController_20.addDiscount(product_id))
      }
  
    // @LINE:132
    case controllers_DiscountController_addDiscountHandle75_route(params@_) =>
      call { 
        controllers_DiscountController_addDiscountHandle75_invoker.call(DiscountController_20.addDiscountHandle)
      }
  
    // @LINE:133
    case controllers_DiscountController_updateDiscount76_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_DiscountController_updateDiscount76_invoker.call(DiscountController_20.updateDiscount(id))
      }
  
    // @LINE:135
    case controllers_DiscountController_updateDiscountHandle77_route(params@_) =>
      call { 
        controllers_DiscountController_updateDiscountHandle77_invoker.call(DiscountController_20.updateDiscountHandle)
      }
  
    // @LINE:137
    case controllers_DiscountController_getDiscounts78_route(params@_) =>
      call { 
        controllers_DiscountController_getDiscounts78_invoker.call(DiscountController_20.getDiscounts)
      }
  
    // @LINE:138
    case controllers_DiscountController_getDiscountpr79_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_DiscountController_getDiscountpr79_invoker.call(DiscountController_20.getDiscountpr(id))
      }
  
    // @LINE:139
    case controllers_DiscountController_getDiscount80_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_DiscountController_getDiscount80_invoker.call(DiscountController_20.getDiscount(id))
      }
  
    // @LINE:140
    case controllers_DiscountController_deleteDiscount81_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_DiscountController_deleteDiscount81_invoker.call(DiscountController_20.deleteDiscount(id))
      }
  
    // @LINE:143
    case controllers_DeliveryController_addDelivery82_route(params@_) =>
      call { 
        controllers_DeliveryController_addDelivery82_invoker.call(DeliveryController_5.addDelivery)
      }
  
    // @LINE:145
    case controllers_DeliveryController_addDeliveryHandle83_route(params@_) =>
      call { 
        controllers_DeliveryController_addDeliveryHandle83_invoker.call(DeliveryController_5.addDeliveryHandle)
      }
  
    // @LINE:146
    case controllers_DeliveryController_updateDelivery84_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_DeliveryController_updateDelivery84_invoker.call(DeliveryController_5.updateDelivery(id))
      }
  
    // @LINE:148
    case controllers_DeliveryController_updateDeliveryHandle85_route(params@_) =>
      call { 
        controllers_DeliveryController_updateDeliveryHandle85_invoker.call(DeliveryController_5.updateDeliveryHandle)
      }
  
    // @LINE:150
    case controllers_DeliveryController_getDeliverys86_route(params@_) =>
      call { 
        controllers_DeliveryController_getDeliverys86_invoker.call(DeliveryController_5.getDeliverys)
      }
  
    // @LINE:151
    case controllers_DeliveryController_getDelivery87_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_DeliveryController_getDelivery87_invoker.call(DeliveryController_5.getDelivery(id))
      }
  
    // @LINE:152
    case controllers_DeliveryController_getDeliveryOrd88_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_DeliveryController_getDeliveryOrd88_invoker.call(DeliveryController_5.getDeliveryOrd(id))
      }
  
    // @LINE:153
    case controllers_DeliveryController_deleteDelivery89_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_DeliveryController_deleteDelivery89_invoker.call(DeliveryController_5.deleteDelivery(id))
      }
  
    // @LINE:156
    case controllers_ReviewController_addReview90_route(params@_) =>
      call { 
        controllers_ReviewController_addReview90_invoker.call(ReviewController_7.addReview)
      }
  
    // @LINE:158
    case controllers_ApplicationController_addReviewHandle91_route(params@_) =>
      call { 
        controllers_ApplicationController_addReviewHandle91_invoker.call(ApplicationController_12.addReviewHandle)
      }
  
    // @LINE:159
    case controllers_ReviewController_updateReview92_route(params@_) =>
      call(params.fromPath[Int]("id", None)) { (id) =>
        controllers_ReviewController_updateReview92_invoker.call(ReviewController_7.updateReview(id))
      }
  
    // @LINE:161
    case controllers_ReviewController_updateReviewHandle93_route(params@_) =>
      call { 
        controllers_ReviewController_updateReviewHandle93_invoker.call(ReviewController_7.updateReviewHandle)
      }
  
    // @LINE:164
    case controllers_ReviewController_review94_route(params@_) =>
      call(params.fromPath[Long]("productid", None)) { (productid) =>
        controllers_ReviewController_review94_invoker.call(ReviewController_7.review(productid))
      }
  
    // @LINE:165
    case controllers_ReviewController_deleteReview95_route(params@_) =>
      call(params.fromPath[Int]("id", None)) { (id) =>
        controllers_ReviewController_deleteReview95_invoker.call(ReviewController_7.deleteReview(id))
      }
  
    // @LINE:168
    case controllers_Assets_versioned96_route(params@_) =>
      call(params.fromPath[String]("file", None)) { (file) =>
        controllers_Assets_versioned96_invoker.call(Assets_19.versioned(file))
      }
  }
}
